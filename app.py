...
def main():
	recr1 = md.Recruiter('Olga Recrutova', 100)
	prog1 = md.Programmer('Roman Programenko', 200, 'Python, Git&GitHub, Django, Django Rest Framework, API')
	prog2 = md.Programmer('Boris Koder', 170, 'Python, Git&GitHub, PyQT5, PyGame')
	...
	cand3 = md.Candidate('Oleg Bekendin', 'obl12021999@gmail.com', 'Java, Spring Framework', 'Teamwork, Communication', 5)
